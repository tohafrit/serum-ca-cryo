...
SHOW_SCENARIOS = list(DISPLAY.keys())   # 5 key scenarios for figs 08 and 09
...
def plot_fig09(rows: list[dict]):
    rows5 = [r for r in rows if r["scenario"] in SHOW_SCENARIOS]
    ...
    w   = 0.35
    fig, (ax_left, ax_right) = plt.subplots(1, 2, figsize=(9.0, 3.8),
    ...
    ax_left.set_xticklabels(names, rotation=22, ha="right", fontsize=7.5)
    ...
    ax_right.set_xticklabels(names, rotation=22, ha="right", fontsize=7.5)
